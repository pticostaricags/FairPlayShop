        ...
        public async Task Test_CreateStoreAsync()
        {
            ...
            await GotoPageAsync(
              ...
              async (page) =>
              {
                  ...
                  await page.Locator("input[name=\"Input\\.Password\"]").FillAsync(TEST_USER_PASSWORD);

                  await page.Locator("input[name=\"Input\\.Password\"]").PressAsync("Tab");

                  await page.Locator("input[name=\"Input\\.ConfirmPassword\"]").FillAsync(TEST_USER_PASSWORD);
                  ...
                  await page.GetByRole(AriaRole.Heading, new() { Name = "Home" }).ClickAsync();

                  await page.GetByText("Welcome to FairPlayShop: A demo project testing .NET 8").ClickAsync();

                  await page.GetByText("Disclaimer: Text translations have been generated by Azure Open AI.AI generated ").ClickAsync();
              },
              Browser.Chromium);
