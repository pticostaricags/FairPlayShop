CREATE TABLE [dbo].[StoreCustomerOrder]
(
    ...
    CONSTRAINT [FK_StoreCustomerOrder_StoreCustomer] FOREIGN KEY ([StoreCustomerId]) REFERENCES [StoreCustomer]([StoreCustomerId])
)
